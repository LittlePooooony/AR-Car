                ...
                if (path != null) {
                    ...
                    if (globalEditorDisplaySettings.visibleWhenNotSelected) {
                        ...
                        for (int i = 0; i < path.NumPoints; i++) {
                            ...
                            Gizmos.DrawLine(MathUtility.TransformPoint(path.GetPoint(i), transform, PathSpace.xyz), MathUtility.TransformPoint(path.GetPoint(nextI), transform, PathSpace.xyz));
                        }
                    }
                }
            }
